...
\begin{document}
  ...
  \begin{tikzpicture}[overlay]
    ...
    \nodeshadowed [at={(-4.5,5  )},yslant=0.05]
        {\Huge La\textcolor{orange}{\emph{T}}eX};
    \nodeshadowed [at={( 0,5.3)}] {\huge \textcolor{mintgreen}{\&}};
    \nodeshadowed [at={( 5,5  )},yslant=-0.05] {\Huge {Pgf\textcolor{cyan}{\emph{p}}lots}};
    \nodeshadowed [at={( 0,2  )}] {TikZ/PGF 绘图入门笔记整理};
    \node [at={( 0,0.3)},color=black!60!green] {\huge \emph{To be continued}};
