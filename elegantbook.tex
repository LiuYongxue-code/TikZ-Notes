  ...
  \begin{minipage}[c]{0.68\linewidth}
  	...
  	{\renewcommand{\arraystretch}{0.618}
  		\begin{tabular}{l}
  			...
  			\ifdefstring{\ELEGANT@lang}{en}{\textbf{Institute: }}{\textbf{Email：}}\the\institute\\
  			
  			\ifdefstring{\ELEGANT@lang}{en}{\textbf{weixin: }}{\textbf{微信公众号：}}\the\weixin\\
  			
  			\ifdefstring{\ELEGANT@lang}{en}{\textbf{Update: }}{\textbf{完成时间：}}\@date\\
  			
  			\ifdefstring{\ELEGANT@lang}{en}{\textbf{Version: }}
  			{\textbf{版本：}}\the\version \\
  	\end{tabular}}
  \end{minipage}
